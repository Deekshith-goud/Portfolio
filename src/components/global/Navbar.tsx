...
import { m as motion, useScroll, useSpring, useVelocity, useTransform, useMotionTemplate } from "framer-motion";
  ...
  return (
    <UnmountStudio>
      <>
        ...
        <motion.header layoutRoot className="fixed top-0 left-0 right-0 z-50 text-sm py-4 md:px-16 px-6 border-b dark:border-zinc-800 border-zinc-200 bg-[#FCFBF8]/60 dark:bg-zinc-900/60 backdrop-blur-xl transition-all duration-300">
